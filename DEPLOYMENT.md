...
4. Set the following environment variables in Railway:
   ...
   - JWT_REFRESH_EXPIRES_IN=7d
    - CORS_ORIGIN=https://edurus.pages.dev,https://704850e1.edurus.pages.dev
...
- Production: https://edurus.pages.dev, https://704850e1.edurus.pages.dev
- Cloudflare Pages preview URLs: All URLs ending with .pages.dev (e.g., https://abc123.edurus.pages.dev)

Cloudflare Pages preview URLs are automatically allowed since they match the wildcard pattern.