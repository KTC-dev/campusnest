    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-6 py-16 md:px-12 max-w-2xl mx-auto prose-sm">
        ...
        <p className="mt-4 text-sm text-slate-500">
          Edurus collects the minimum data needed to create accounts, verify agents, facilitate bookings, and improve the platform experience. We store account information, listing details, verification documents, booking activity, and communication metadata in a secure environment.
        </p>
        <div className="mt-6 space-y-4 text-sm text-slate-600">
          ...
          <p><strong>How we use it:</strong> to create accounts, verify agent identity, coordinate bookings, enable messaging, and meet legal or security obligations.</p>
