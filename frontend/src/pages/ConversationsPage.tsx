        ...
        <Shell>
            <div className="page-transition space-y-4">
                <section className="mobile-card-compact p-4">
                    ...
                    <h1 className="mt-1 text-2xl font-display font-bold text-slate-800">Your conversations</h1>
                </section>

                <main className="space-y-4">
                    <aside className="mobile-card-compact p-4">
                    ...
                    <section className="mobile-card-compact shadow-sm">
                                    ...
                                    <form onSubmit={handleSendMessage} className="border-t border-slate-200 p-4">
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 rounded-full border border-slate-200 px-4 py-3 text-sm outline-none"
                                            />
                                            <button type="submit" disabled={isSending} className="rounded-full bg-brand-900 px-4 py-3 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:opacity-70">{isSending ? "Sending..." : "Send"}</button>
                                        </div>
                                    </form>
                                </div>
                            </>
